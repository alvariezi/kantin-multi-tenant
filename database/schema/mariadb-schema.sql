...
CREATE TABLE `tenant_orders` (
  ...
  KEY `tenant_orders_tenant_id_foreign` (`tenant_id`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2026_09_10_170408_add_role_and_status_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2026_09_10_170429_create_tenancy_and_catalog_tables',1);
